...
use ron;
use crate::compendium::Background;

static BACKGROUNDS: SyncLazy<Vec<Background>> = SyncLazy::new(|| {
    ron::from_str::<Vec<Background>>(SRD_BACKGROUNDS).unwrap()
});
...
Background(
    ...
    traits:{
        "Skill Proficiencies":
            "Insight, Religion",
        ".skills.insight": "Proficient",
        ".skills.religion": "Proficient",
        "Languages":
            "Two of your choice",
        "Equipment":
...
Background(
    ...
    traits:{
        ...
        ".skills.animal_handling": "Proficient",
        ".skills.survival": "Proficient",
        "Tool Proficiencies":

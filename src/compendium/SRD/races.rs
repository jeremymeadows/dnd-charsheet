...
static RACES: SyncLazy<Vec<Race>> = SyncLazy::new(|| {
...
pub fn get_race(name: &str) -> Option<Race> {
    RACES.iter().find(|e| e.name == name).cloned()
}
...
Race(
    ...
    traits:{
        ...
        ".saves.advantage": "intelligence",
        ".saves.advantage": "wisdom",
        ".saves.advantage": "charisma",
        "Languages":
            "You can speak, read, and write Common and Gnomish. The Gnomish language, which uses the Dwarvish script, is renowned for its technical treatises and its catalogs of knowledge about the natural world.",
        "Artificer's Lore":
            "Whenever you make an Intelligence (History) check related to magic items, alchemical objects, or technological devices, you can add twice your proficiency bonus, instead of any proficiency bonus you normally apply.",
        ".skills.history" : "Expert",
        "Tinker":
